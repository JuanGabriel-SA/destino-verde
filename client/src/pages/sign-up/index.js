...
export default function SignUp() {
    ...
    async function createUser() {
        if (await validateUser()) {
            ...
            await fetch('https://destino-verde-f6428812864e.herokuapp.com/new-user', {
                headers: {
    ...
    async function validateUser() {
        ...
        const user = await fetch(`https://destino-verde-f6428812864e.herokuapp.com/verify-user/${email}`).then(res => res.json());
